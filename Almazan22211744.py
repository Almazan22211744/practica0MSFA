...
Nombre del alumno: Almazan Pacheco Maria Fernanda
Número de control: 22211744
Correo institucional: L22211744@tectijuana.edu.mx
...
u1 = np.ones(n)
u2 = np.zeros(n); u2[round(1/dt):round(2/dt)]
u3 = t/tend
u4 = np.sin(m.pi/2*t)
...
print(f"funcion de trasferenciaa del sistema:{sys}")
...
Rr = KP*Re
Ce = KD/Rr
print (f"El valor de la capacitancia propuesta es Cr es de {Cr} faradios.")
print(f"El valor de la resistencia de Re es de {Re} ohms")
print(f"El valor de la resistencia es Rr es de {Rr} ohms")
print (f"el valor de la capacitancia es Ce es de {Ce} faradios.")
...
print(f"Funcion de transferencia del sistema del control del lazo cerrado {sysPID}")
